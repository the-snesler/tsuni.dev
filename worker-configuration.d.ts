/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: a7b985194a83c62d5e562290cdb0d27a)
...
declare namespace NodeJS {
  interface ProcessEnv
    extends StringifyValues<
      Pick<Cloudflare.Env, 'GISCUS_REPO' | 'GISCUS_REPO_ID' | 'GISCUS_CATEGORY' | 'GISCUS_CATEGORY_ID' | 'GUESTBOOK_SECRET_KEY' | 'GUESTBOOK_WEBHOOK'>
    > {}
}
